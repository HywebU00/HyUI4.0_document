...
主選單標籤為<font color="#EE428B">nav.menu</font>及<font color="#EE428B">nav.megamenu</font>([範例](https://hywebu00.github.io/hyui_flex/lp_template.htm))目前預設為最多 <font color="#EE428B">4</font> 層。
