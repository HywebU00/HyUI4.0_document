...
HyUI 使用<font color="#009ee7"> fancybox </font>的燈箱套件，目前 hyUI <font color="#EE428B"> vendor </font>內含<font color="#EE428B"> fancybox </font>已經有加入客製化設定，如需要最新版，請到 [fancybox](https://fancyapps.com/fancybox/3/docs/#usage) 官網參考下載。
